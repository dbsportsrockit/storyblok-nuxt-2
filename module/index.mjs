...
const nuxtModule = function (moduleOptions) {
  ...
  else if (Array.isArray(nuxtConfig.components.dirs))
    nuxtConfig.components.dirs.push(componentsPath);
  ...
  this.options.alias["@storyblok/nuxt-2"] =
    this.options.alias["@storyblok/nuxt-2"] ||
    this.nuxt.resolver.resolveModule("@storyblok/nuxt-2");
